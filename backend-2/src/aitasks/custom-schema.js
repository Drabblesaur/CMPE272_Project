...
async function generateCustom(schema, language, database, userInput) {
    try {
        console.log('Checkpoint 1: Starting CRUD API generation');
        console.log(`Parameters received - Schema: ${schema}, Language: ${language}, Database: ${database}, userInput: ${userInput}`);
